...
if(cmd === `${prefix}wfl`) return sendMsg(`https://wii.guide/wiiflow`);                                
...
if(cmd === `${prefix}botinvite`) return sendMsg(`https://discord.com/oauth2/authorize?client_id=788308728423120896&scope=bot&permissions=117760`);                                    
